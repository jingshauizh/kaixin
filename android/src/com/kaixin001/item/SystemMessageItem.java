...
public class SystemMessageItem
{
  ...
  String mSmid;
  String mSource = "";
  SystemMessageItem mSourceItem = null;
  ...
  public SystemMessageItem getSourceItem()
  {
  ...
  {
    this.mSourceItem = SystemMessageItem.valueOf(paramJSONObject);
  }

  private static SystemMessageItem valueOf(JSONObject paramJSONObject) {
