...
public class Setting extends KXModel
{
  ...
  public static final String APP_CIRCLE_ME_REPLY = "APP_CIRCLE_ME_REPLY";
  public static final String APP_CIRCLE_REPLY_ME = "APP_CIRCLE_REPLY_ME";
  ...
  public static final String APP_REPOST_ALBUM = "杞彂鐓х墖涓撹緫";
  public static final String APP_REPOST_PHOTO = "杞彂鐓х墖";
  public static final String APP_REPOST_VOTE = "杞彂鎶曠エ";
  ...
  public int getAppIcon(String paramString1, String paramString2)
  {
	...
	if (!"1242".equals(paramString1))
		return -1;
	if ("杞彂鐓х墖涓撹緫".equals(paramString2))
	  return 2130839104;
	if ("杞彂鐓х墖".equals(paramString2))
	  return 2130839104;
	if ("杞彂鎶曠エ".equals(paramString2))
	      return 2130838702;	 
