...
final class FieldParser
{
  ...
  static
  {
    ...
    arrayOfObject11[2] = new Integer(20);
    ...
    arrayOfObject12[2] = new Integer(29);
    ...
    arrayOfObject13[2] = new Integer(8);
    ...
    arrayOfObject14[2] = new Integer(8);
    ...
    arrayOfObject15[2] = new Integer(30);
    ...
    arrayOfObject16[2] = new Integer(30);
    ...
    arrayOfObject17[2] = new Integer(30);
    ...
    arrayOfObject18[2] = new Integer(30);
    ...
    arrayOfObject19[2] = new Integer(30);
    ...
    arrayOfObject20[2] = new Integer(30);
    ...
    arrayOfObject21[2] = new Integer(30);
    ...
    arrayOfObject22[2] = new Integer(30);
    ...
    arrayOfObject23[2] = new Integer(30);
    ...
    arrayOfObject24[2] = new Integer(30);
    ...
    arrayOfObject25[2] = new Integer(30);
    ...
    arrayOfObject26[2] = new Integer(30);
    ...
    arrayOfObject27[2] = new Integer(6);
    ...
    arrayOfObject28[2] = new Integer(30);
    ...
    arrayOfObject29[2] = new Integer(30);
    ...
    arrayOfObject30[2] = new Integer(17);
    ...
    arrayOfObject31[2] = new Integer(20);
    ...
    arrayOfObject32[2] = new Integer(30);
    ...
    arrayOfObject41[2] = new Integer(20);
    ...
    arrayOfObject100[2] = new Integer(15);
    ...
    arrayOfObject101[2] = new Integer(18);
    ...
    arrayOfObject102[2] = new Integer(15);
    ...
    arrayOfObject103[2] = new Integer(18);
    ...
    arrayOfObject104[2] = new Integer(30);
    ...
    arrayOfObject105[1] = new Integer(13);
    ...
    arrayOfObject109[2] = new Integer(20);
    ...
    arrayOfObject110[2] = new Integer(30);
    ...
    arrayOfObject114[2] = new Integer(30);
    ...
    arrayOfObject121[2] = new Integer(30);
    ...
    throws NotFoundException
  {
    ...
    for (int i = 0; ; i++)
    {
      ...
      if (!TWO_DIGIT_DATA_LENGTH[i][0].equals(str1))
        continue;
    ...
    for (int k = 0; ; k++)
    {
      if (k >= THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH.length)
      {
        if (paramString.length() >= 4)
          break label316;
        throw NotFoundException.getNotFoundInstance();
        if (THREE_DIGIT_DATA_LENGTH[j][0].equals(str2))
        {
          if (THREE_DIGIT_DATA_LENGTH[j][1] == VARIABLE_LENGTH)
            return processVariableAI(3, ((Integer)THREE_DIGIT_DATA_LENGTH[j][2]).intValue(), paramString);
          return processFixedAI(3, ((Integer)THREE_DIGIT_DATA_LENGTH[j][1]).intValue(), paramString);
        }
        j++;
        break;
      }
      if (!THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH[k][0].equals(str2))
        continue;
      if (THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH[k][1] == VARIABLE_LENGTH)
        return processVariableAI(4, ((Integer)THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH[k][2]).intValue(), paramString);
      return processFixedAI(4, ((Integer)THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH[k][1]).intValue(), paramString);
    }
    label316: String str3 = paramString.substring(0, 4);
    for (int m = 0; ; m++)
    {
      if (m >= FOUR_DIGIT_DATA_LENGTH.length)
        throw NotFoundException.getNotFoundInstance();
      if (!FOUR_DIGIT_DATA_LENGTH[m][0].equals(str3))
        continue;
      if (FOUR_DIGIT_DATA_LENGTH[m][1] == VARIABLE_LENGTH)
        return processVariableAI(4, ((Integer)FOUR_DIGIT_DATA_LENGTH[m][2]).intValue(), paramString);
      return processFixedAI(4, ((Integer)FOUR_DIGIT_DATA_LENGTH[m][1]).intValue(), paramString);
    }
  }
    ...
    throws NotFoundException
  {
    ...
    return '(' + str1 + ')' + str2 + parseFieldsInGeneralPurpose(str3);
  }
