...
public final class HostAndPort
{
  ...
  public static HostAndPort fromString(String paramString)
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        return new HostAndPort(str1, j, bool);
  ...
  public boolean equals(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      if ((!Objects.equal(this.host, localHostAndPort.host)) || (this.port != localHostAndPort.port) || (this.hasBracketlessColons != localHostAndPort.hasBracketlessColons))
        return false;
    }
    return false;
  }
