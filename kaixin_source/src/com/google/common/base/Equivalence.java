    ...
    implements Predicate<T>, Serializable
  {
    ...
    public boolean equals(@Nullable Object paramObject)
    {
      ...
      while (true)
      {
        ...
        if ((!this.equivalence.equals(localEquivalentToPredicate.equivalence)) || (!Objects.equal(this.target, localEquivalentToPredicate.target)))
          return false;
      }
      return false;
    }
    ...
    implements Serializable
  {
    ...
    public boolean equals(@Nullable Object paramObject)
    {
      ...
      while (true)
      {
        ...
        if ((!localEquivalence.equals(localWrapper.equivalence)) || (!localEquivalence.equivalent(this.reference, localWrapper.reference)))
          return false;
      }
      return false;
    }
