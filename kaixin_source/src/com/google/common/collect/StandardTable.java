...
import java.util.Set<Ljava.util.Map.Entry<TC;TV;>;>;
  ...
  implements Table<R, C, V>, Serializable
{
  ...
  class Row extends AbstractMap<C, V>
  {
    ...
    public Set<Map.Entry<C, V>> entrySet()
    {
      ...
      return (Set<Map.Entry<C, V>>)localObject;
    }
    ...
    public V remove(Object paramObject)
    {
      try
      {
        ...
        if (localMap == null)
          return null;
        Object localObject = localMap.remove(paramObject);
        maintainEmptyInvariant();
        return localObject;
      }
    ...
    private class RowEntrySet extends Maps.EntrySet<C, V>
    {
      ...
      public Iterator<Map.Entry<C, V>> iterator()
      {
        ...
        return new Iterator(localMap.entrySet().iterator())
        {
          public boolean hasNext()
          {
