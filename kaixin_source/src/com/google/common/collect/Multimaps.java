...
public final class Multimaps
{
  ...
  static abstract class Keys<K, V> extends AbstractMultiset<K>
  {
    ...
    {
      return new Iterator(multimap().asMap().entrySet().iterator())
      {
        ...
        {
          return new Multisets.AbstractEntry((Map.Entry)this.val$backingIterator.next())
          {
            public int getCount()
            {
  ...
  static abstract class Values<K, V> extends AbstractCollection<V>
  {
    ...
    public Iterator<V> iterator()
    {
      return new Iterator(multimap().entries().iterator())
      {
        public boolean hasNext()
        {
          return this.val$backingIterator.hasNext();
