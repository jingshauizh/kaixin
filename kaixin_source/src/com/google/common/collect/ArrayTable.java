  ...
  implements Table<R, C, V>, Serializable
{
  ...
  private ArrayTable(ArrayTable<R, C, V> paramArrayTable)
  {
    ...
    Object[][] arrayOfObject = (Object[][])(Object[][])Array.newInstance(Object.class, new int[] { this.rowList.size(), this.columnList.size() });
  ...
  public V[][] toArray(Class<V> paramClass)
  {
    ...
    Object[][] arrayOfObject = (Object[][])(Object[][])Array.newInstance(paramClass, arrayOfInt);
    for (int i = 0; i < this.rowList.size(); i++)
  ...
  private class CellSet extends AbstractSet<Table.Cell<R, C, V>>
  {
    ...
    public boolean contains(Object paramObject)
    {
      ...
      if (bool1)
      {
        ...
        if (localInteger1 != null)
        {
          ...
          if (localInteger2 != null)
          {
            boolean bool2 = Objects.equal(ArrayTable.this.array[localInteger1.intValue()][localInteger2.intValue()], localCell.getValue());
            i = 0;
            if (bool2)
              i = 1;
          }
    ...
    public Iterator<Table.Cell<R, C, V>> iterator()
    {
      return new AbstractIndexedListIterator(size())
      {
        ...
        {
          return new Tables.AbstractCell(paramInt)
          {
            final int columnIndex = this.val$index % ArrayTable.this.columnList.size();
            final int rowIndex = this.val$index / ArrayTable.this.columnList.size();
  ...
  private class Column extends AbstractMap<R, V>
  {
    ...
    public V put(R paramR, V paramV)
    {
      ...
      for (boolean bool = true; ; bool = false)
      {
        ...
        arrayOfObject[1] = ArrayTable.access$200(ArrayTable.this);
  ...
  private class ColumnEntrySet extends AbstractSet<Map.Entry<R, V>>
  {
    ...
    public Iterator<Map.Entry<R, V>> iterator()
    {
      return new AbstractIndexedListIterator(size())
      {
        protected Map.Entry<R, V> get(int paramInt)
        {
          return new AbstractMapEntry(paramInt)
          {
            public R getKey()
            {
            ...
            public V getValue()
            {
              return ArrayTable.this.array[this.val$rowIndex][ArrayTable.ColumnEntrySet.this.columnIndex];
            }

            public V setValue(V paramV)
            {
              return ArrayTable.this.set(this.val$rowIndex, ArrayTable.ColumnEntrySet.this.columnIndex, paramV);
            }
          };
        }
      };
  ...
  private class ColumnMapEntrySet extends AbstractSet<Map.Entry<C, Map<R, V>>>
  {
    ...
    public Iterator<Map.Entry<C, Map<R, V>>> iterator()
    {
      return new AbstractIndexedListIterator(size())
      {
        protected Map.Entry<C, Map<R, V>> get(int paramInt)
        {
          return Maps.immutableEntry(ArrayTable.this.columnList.get(paramInt), new ArrayTable.Column(ArrayTable.this, paramInt));
        }
      };
    }
  ...
  private class Row extends AbstractMap<C, V>
  {
    ...
    public V put(C paramC, V paramV)
    {
      ...
      for (boolean bool = true; ; bool = false)
      {
        ...
        arrayOfObject[1] = ArrayTable.access$100(ArrayTable.this);
  ...
  private class RowEntrySet extends AbstractSet<Map.Entry<C, V>>
  {
    ...
    public Iterator<Map.Entry<C, V>> iterator()
    {
      return new AbstractIndexedListIterator(size())
      {
        protected Map.Entry<C, V> get(int paramInt)
        {
          return new AbstractMapEntry(paramInt)
          {
            public C getKey()
            ...
            public V getValue()
            {
              return ArrayTable.this.array[ArrayTable.RowEntrySet.this.rowIndex][this.val$columnIndex];
            }

            public V setValue(V paramV)
            {
              return ArrayTable.this.set(ArrayTable.RowEntrySet.this.rowIndex, this.val$columnIndex, paramV);
            }
          };
        }
      };
  ...
  private class RowMapEntrySet extends AbstractSet<Map.Entry<R, Map<C, V>>>
  {
    ...
    public Iterator<Map.Entry<R, Map<C, V>>> iterator()
    {
      return new AbstractIndexedListIterator(size())
      {
        protected Map.Entry<R, Map<C, V>> get(int paramInt)
        {
          return Maps.immutableEntry(ArrayTable.this.rowList.get(paramInt), new ArrayTable.Row(ArrayTable.this, paramInt));
        }
      };
    }
  ...
  private class Values extends AbstractCollection<V>
  {
    ...
    public Iterator<V> iterator()
    {
      return new AbstractIndexedListIterator(size())
      {
        ...
        {
          int i = paramInt / ArrayTable.this.columnList.size();
          int j = paramInt % ArrayTable.this.columnList.size();
