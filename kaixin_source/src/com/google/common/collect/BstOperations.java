...
final class BstOperations
{
  ...
  public static <K, N extends BstNode<K, N>> BstMutationResult<K, N> mutate(Comparator<? super K> paramComparator, BstMutationRule<K, N> paramBstMutationRule, @Nullable N paramN, K paramK)
  {
  ...
  @Nullable
  public static <K, N extends BstNode<K, N>> N seek(Comparator<? super K> paramComparator, @Nullable N paramN, K paramK)
  {
    Preconditions.checkNotNull(paramComparator);
    if (paramN == null)
      paramN = null;
