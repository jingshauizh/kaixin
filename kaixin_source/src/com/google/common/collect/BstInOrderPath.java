...
final class BstInOrderPath<N extends BstNode<?, N>> extends BstPath<N, BstInOrderPath<N>>
{
  ...
  public static <N extends BstNode<?, N>> BstPathFactory<N, BstInOrderPath<N>> inOrderFactory()
  {
    ...
    {
      public BstInOrderPath<N> extension(BstInOrderPath<N> paramBstInOrderPath, BstSide paramBstSide)
      {
        return BstInOrderPath.access$000(paramBstInOrderPath, paramBstSide);
      }

      public BstInOrderPath<N> initialPath(N paramN)
      {
        return new BstInOrderPath(paramN, null, null, null);
      }
    };
  }
