...
class ComputingConcurrentHashMap<K, V> extends CustomConcurrentHashMap<K, V>
{
  ...
  CustomConcurrentHashMap.Segment<K, V> createSegment(int paramInt1, int paramInt2)
  {
  ...
  static final class ComputingSegment<K, V> extends CustomConcurrentHashMap.Segment<K, V>
  {
    ComputingSegment(CustomConcurrentHashMap<K, V> paramCustomConcurrentHashMap, int paramInt1, int paramInt2)
    {
      super(paramInt1, paramInt2);
    }

    V compute(K paramK, int paramInt, CustomConcurrentHashMap.ReferenceEntry<K, V> paramReferenceEntry, ComputingConcurrentHashMap.ComputingValueReference<K, V> paramComputingValueReference)
      throws ExecutionException
    {
      ...
      throws ExecutionException
    {
      ...
      //   1: aload_1
      //   2: iload_2
      //   3: invokevirtual 48	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:getEntry	(Ljava/lang/Object;I)Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;
      //   6: astore 5
      //   8: aload 5
      //   10: ifnull +29 -> 39
      //   13: aload_0
      //   14: aload 5
      //   16: invokevirtual 52	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:getLiveValue	(Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;)Ljava/lang/Object;
      //   19: astore 6
      //   21: aload 6
      //   23: ifnull +16 -> 39
      //   26: aload_0
      //   27: aload 5
      //   29: invokevirtual 56	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:recordRead	(Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;)V
      //   32: aload_0
      ...
      //   102: checkcast 62	com/google/common/collect/CustomConcurrentHashMap$ReferenceEntry
      //   105: astore 12
      //   107: aload 12
      //   109: astore 5
      //   111: aload 5
      ...
      //   138: ifnull +268 -> 406
      //   141: aload_0
      //   142: getfield 107	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:map	Lcom/google/common/collect/CustomConcurrentHashMap;
      //   145: getfield 113	com/google/common/collect/CustomConcurrentHashMap:keyEquivalence	Lcom/google/common/base/Equivalence;
      //   148: aload_1
      //   149: aload 13
      ...
      //   200: iload_2
      //   201: aload 12
      //   203: invokevirtual 126	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:newEntry	(Ljava/lang/Object;ILcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;)Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;
      //   206: astore 5
      //   208: aload 5
      //   210: aload 16
      ...
      //   246: aload 5
      //   248: aload 15
      //   250: invokevirtual 142	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:compute	(Ljava/lang/Object;ILcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;Lcom/google/common/collect/ComputingConcurrentHashMap$ComputingValueReference;)Ljava/lang/Object;
      //   253: astore 17
      //   255: aload_0
      ...
      //   347: athrow
      //   348: aload_0
      //   349: getfield 107	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:map	Lcom/google/common/collect/CustomConcurrentHashMap;
      //   352: invokevirtual 163	com/google/common/collect/CustomConcurrentHashMap:expires	()Z
      //   355: ifeq +30 -> 385
      //   358: aload_0
      //   359: getfield 107	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:map	Lcom/google/common/collect/CustomConcurrentHashMap;
      //   362: aload 5
      //   364: invokevirtual 167	com/google/common/collect/CustomConcurrentHashMap:isExpired	(Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;)Z
      //   367: ifeq +18 -> 385
      //   370: aload_0
      //   371: aload 13
      //   373: iload_2
      ...
      //   385: aload_0
      //   386: aload 5
      //   388: invokevirtual 173	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:recordLockedRead	(Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;)V
      //   391: aload_0
      ...
      //   475: aload_0
      //   476: aload 5
      //   478: invokevirtual 56	com/google/common/collect/ComputingConcurrentHashMap$ComputingSegment:recordRead	(Lcom/google/common/collect/CustomConcurrentHashMap$ReferenceEntry;)V
      //   481: aload_0
  ...
  static final class ComputingSerializationProxy<K, V> extends CustomConcurrentHashMap.AbstractSerializationProxy<K, V>
  {
    private static final long serialVersionUID = 4L;
    final Function<? super K, ? extends V> computingFunction;
      ...
      throws ExecutionException
    {
      ...
      try
      {
        ...
        try
        {
          while (true)
          {
            CustomConcurrentHashMap.ValueReference localValueReference1 = this.computedReference;
            CustomConcurrentHashMap.ValueReference localValueReference2 = CustomConcurrentHashMap.UNSET;
