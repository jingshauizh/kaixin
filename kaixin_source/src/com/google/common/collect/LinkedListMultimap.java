...
import java.util.List<Ljava.util.Map.Entry<TK;TV;>;>;
  ...
  implements ListMultimap<K, V>, Serializable
{
  ...
  {
    return new AbstractMapEntry(paramNode)
    {
      public K getKey()
      {
  ...
  public List<Map.Entry<K, V>> entries()
  {
    ...
    if (localObject == null)
    {
      localObject = new AbstractSequentialList()
      {
        ...
        {
          return new ListIterator(new LinkedListMultimap.NodeIterator(LinkedListMultimap.this, paramInt))
          {
            ...
            {
              return LinkedListMultimap.access$1100((LinkedListMultimap.Node)this.val$nodes.next());
            }
            ...
            {
              return LinkedListMultimap.access$1100((LinkedListMultimap.Node)this.val$nodes.previous());
            }
    ...
    return (List<Map.Entry<K, V>>)localObject;
  }
      ...
      localObject = new AbstractSequentialList()
      {
        public ListIterator<V> listIterator(int paramInt)
        {
          return new ListIterator(new LinkedListMultimap.NodeIterator(LinkedListMultimap.this, paramInt))
          {
            ...
            {
              this.val$nodes.setValue(paramV);
            }
          };
        }
    ...
    implements Iterator<K>
  {
    ...
    public K next()
    {
      LinkedListMultimap.access$200(this.next);
    ...
    implements Multiset<K>
  {
    ...
    public Iterator<K> iterator()
    {
      return new Iterator(new LinkedListMultimap.NodeIterator(LinkedListMultimap.this))
      {
        public boolean hasNext()
        {
          return this.val$nodes.hasNext();
    ...
    implements ListIterator<LinkedListMultimap.Node<K, V>>
  {
    ...
    {
      LinkedListMultimap.access$200(this.previous);
