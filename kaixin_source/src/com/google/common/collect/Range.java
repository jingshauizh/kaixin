  ...
  implements Predicate<C>, Serializable
{
  ...
  public ContiguousSet<C> asSet(DiscreteDomain<C> paramDiscreteDomain)
  {
    ...
    return (ContiguousSet<C>)new RegularContiguousSet((Range)localObject, paramDiscreteDomain);
  }
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    if (bool1)
    {
      ...
      boolean bool2 = this.lowerBound.equals(localRange.lowerBound);
      i = 0;
      if (bool2)
      {
        boolean bool3 = this.upperBound.equals(localRange.upperBound);
        i = 0;
        if (bool3)
          i = 1;
      }
