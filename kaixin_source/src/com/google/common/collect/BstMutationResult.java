...
final class BstMutationResult<K, N extends BstNode<K, N>>
{
  ...
  private BstMutationResult(K paramK, @Nullable N paramN1, @Nullable N paramN2, BstModificationResult<N> paramBstModificationResult)
  {
    this.targetKey = Preconditions.checkNotNull(paramK);
  ...
  public static <K, N extends BstNode<K, N>> BstMutationResult<K, N> mutationResult(K paramK, @Nullable N paramN1, @Nullable N paramN2, BstModificationResult<N> paramBstModificationResult)
  {
