...
public class WebViewDialog extends Dialog
{
  ...
  private WebViewDialog.OnTimeListener mListener;
  ...
  public WebViewDialog(Context paramContext, String paramString1, String paramString2, IUiListener paramIUiListener, QQToken paramQQToken)
  {
    super(paramContext, 16973840);
    sWeakContext = new WeakReference(paramContext);
    this.mUrl = paramString2;
    this.mListener = new WebViewDialog.OnTimeListener(paramContext, paramString1, paramString2, paramQQToken.getAppId(), paramIUiListener);
    this.mHandler = new WebViewDialog.THandler(this.mListener, paramContext.getMainLooper());
  ...
  private void createProgress()
  {
    ...
    while (true)
    {
      ...
      return;
      label324: localTextView.setText("Logging in...");
    }
  }
  ...
  private void initViews()
  {
    ...
    this.mWebView.setWebViewClient(new WebViewDialog.FbWebViewClient(this, null));
    ...
    try
    {
      ...
      arrayOfObject[0] = new WebViewDialog.JsListener(this, null);
 ...
 * Qualified Name:     com.tencent.sdkutil.WebViewDialog
