...
public final class LocaleUtil
{
  ...
  {
    String str1 = Util.nullAsNil(paramSharedPreferences.getString("language_key", null));
    if ((str1.length() > 0) && (!str1.equals("language_default")))
    {
      SystemProperty.setProperty("language_key", str1);
      return str1;
    }
    String str2 = d("en");
    SystemProperty.setProperty("language_key", str2);
    return str2;
  }

  public static String loadApplicationLanguageSettings(SharedPreferences paramSharedPreferences, Context paramContext)
  {
    String str = Util.nullAsNil(paramSharedPreferences.getString("language_key", null));
