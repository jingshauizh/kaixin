...
public class AddShareView extends Activity
{
  ...
  private Handler handler = new Handler()
  {
    public void handleMessage(Message paramMessage)
    {
      ...
      try
      {
        ...
        do
          return;
        while ((AddShareView.this.dialog == null) || (!AddShareView.this.dialog.isShowing()));
  ...
  private JsInterface js_interface = new JsInterface(new Callback()
  {
    ...
    {
      AddShareView.this.runOnUiThread(new Runnable(paramInt, paramString)
      {
        int real_ret;

        public void run()
        {
          Toast localToast = Toast.makeText(AddShareView.this, "分享失败，错误信息:" + this.real_ret + ", " + this.val$msg, 0);
    ...
    {
      AddShareView.this.runOnUiThread(new Runnable()
      {
        public void run()
        {
          Toast localToast = Toast.makeText(AddShareView.this, "分享成功！", 0);
          localToast.setGravity(17, 0, 0);
          localToast.show();
        }
      });
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (localBundle != null)
    {
      ...
      String str14 = String.format("http://qzs.qq.com/open/mobile/sendstory/sdk_sendstory.html?access_token=%s&oauth_consumer_key=%s&openid=%s&", new Object[] { str2, str1, str4 });
      ...
      String str15 = str14 + localStringBuilder.toString();
