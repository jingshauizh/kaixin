...
public class UserDBAdapter extends KXBaseDBAdapter
{
  ...
  private static final String[] SELECT_PROJECTS = { "account", "password", "uid", "name", "state", "coverUrl", "logo50", "access_token", "refresh_token", "oauth_token_secret", "expires_in", "reserved", "_id", "islogin", "recent_time_login" };
  ...
  private ContentValues convertToContentValues(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, String paramString7, int paramInt)
  {
  ...
  public int addBlockedCircle(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    Cursor localCursor;
    ...
    try
    {
      localCursor = super.query("circles", _COLUMNS_FOR_QUERY, " uid=? and circleid=?", new String[] { paramString1, paramString2 }, null, null, null, null);
      ContentValues localContentValues = new ContentValues();
      ...
      if ((localCursor != null) && (localCursor.getCount() > 0))
      {
        if (localCursor.moveToFirst())
        {
          ...
          long l2 = super.update("circles", localContentValues, "_rowid=" + l1, null);
          int i = (int)l2;
          return i;
        }
      }
  ...
  public long addLoginUserinfo(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, String paramString7)
  {
    ContentValues localContentValues1 = new ContentValues();
    localContentValues1.put("islogin", Integer.valueOf(0));
    update("users", localContentValues1, "islogin=1", null);
    ContentValues localContentValues2 = convertToContentValues(paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramLong, paramString7, 1);
    localContentValues2.put("recent_time_login", Long.valueOf(System.currentTimeMillis()));
    return super.insert("users", null, localContentValues2);
  }

  public int clearAllUsersInfo()
  {
    super.update("users", convertToContentValues("", "", "", "", "", "", 0L, "", 0), null, null);
    return 0;
  }
  ...
  public Cursor getAllUserName()
    throws SQLException
  {
    Cursor localCursor = super.query(true, "users", SELECT_PROJECTS, "access_token NOT NULL and access_token != ''", null, null, null, "recent_time_login desc", null);
    if (localCursor != null)
      localCursor.moveToFirst();
    return localCursor;
  }

  public Cursor getLoginedUser()
    throws SQLException
  {
    Cursor localCursor = super.query(true, "users", SELECT_PROJECTS, "access_token NOT NULL and access_token != '''' and islogin== 1", null, null, null, null, null);
    if (localCursor != null)
      localCursor.moveToFirst();
    return localCursor;
  }

  public long insertUser(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, String paramString7)
  {
    ContentValues localContentValues = convertToContentValues(paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramLong, paramString7, 0);
    localContentValues.put("recent_time_login", Long.valueOf(System.currentTimeMillis()));
  ...
  public ArrayList<String> loadBlockedCircles(String paramString)
  {
    ...
    try
    {
      localCursor = super.query("circles", _COLUMNS_FOR_QUERY, " uid=?", new String[] { paramString }, null, null, null, null);
      int i;
      if ((localCursor != null) && (localCursor.getCount() > 0))
  ...
  public long saveUserLoginInfo(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, String paramString7)
  {
    Cursor localCursor = null;
    try
    {
      String str = "account = \"" + paramString1 + "\"";
      localCursor = super.query("users", new String[] { "_id" }, str, null, null, null, null);
      long l2;
      if ((localCursor != null) && (localCursor.getCount() > 0))
      {
        if (localCursor.moveToFirst())
        {
          ...
          long l3 = updateUserLoginInfo(l2, paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramLong, paramString7);
          if (l3 > 0L)
            return l2;
        }
      }
      ...
      {
        long l1 = addLoginUserinfo(paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramLong, paramString7);
        l2 = l1;
        return l2;
      }
      return -1L;
  ...
  public long updateUserInfo(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ContentValues localContentValues = new ContentValues();
    ...
    return super.update("users", localContentValues, "uid='" + paramString1 + "'", null);
  }

  public long updateUserLoginInfo(long paramLong1, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong2, String paramString7)
  {
    ContentValues localContentValues1 = new ContentValues();
    localContentValues1.put("islogin", Integer.valueOf(0));
    update("users", localContentValues1, "islogin== 1", null);
    ContentValues localContentValues2 = convertToContentValues(paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramLong2, paramString7, 1);
    localContentValues2.put("recent_time_login", Long.valueOf(System.currentTimeMillis()));
    return super.update("users", localContentValues2, "_id=" + paramLong1, null);
  }
}

/* Location:           C:\9exce\android\pj\kaixin_android_3.9.9_034_kaixin001\classes_dex2jar.jar
 * Qualified Name:     com.kaixin001.db.UserDBAdapter
