...
import com.kaixin001.zxing.PlanarYUVLuminanceSource;
...
public final class CameraManager
{
  ...
  public PlanarYUVLuminanceSource buildLuminanceSource(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    default:
      if (!"yuv420p".equals(str))
        break;
      return new PlanarYUVLuminanceSource(paramArrayOfByte, paramInt1, paramInt2, localRect.left, localRect.top, localRect.width(), localRect.height(), this.reverseImage);
    case 16:
    case 17:
      return new PlanarYUVLuminanceSource(paramArrayOfByte, paramInt1, paramInt2, localRect.left, localRect.top, localRect.width(), localRect.height(), this.reverseImage);
    }
  ...
  public Rect getFramingRect()
  {
    ...
    while (true)
    {
      ...
      int m = (localPoint.y - j - (int)(1.5F * (48.0F * this.context.getResources().getDisplayMetrics().density))) / 2;
      this.framingRect = new Rect(k, m, k + i, m + j);
      KXLog.d(TAG, "Calculated framing rect: " + this.framingRect);
  ...
  public void setManualFramingRect(int paramInt1, int paramInt2)
  {
    ...
    KXLog.d(TAG, "Calculated manual framing rect: " + this.framingRect);
    this.framingRectInPreview = null;
  }
 ...
 * Qualified Name:     com.kaixin001.zxing.camera.CameraManager
