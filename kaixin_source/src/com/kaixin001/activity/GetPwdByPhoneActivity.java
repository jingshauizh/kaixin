  ...
  implements View.OnClickListener
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    setTitleBar();
    this.webView = ((WebView)findViewById(2131362993));
      ...
      this.webView.setWebViewClient(new WebViewClient()
      {
        public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
        {
          if ((paramString.startsWith("sms:")) || (paramString.startsWith("smsto:")))
            GetPwdByPhoneActivity.this.doEnroll(paramString.substring(1 + paramString.indexOf(":"), paramString.length()));
          return true;
        }
      });
      this.webView.loadUrl("http://iphone.kaixin001.com/reg/client-forget.html");
      return;
    }
  ...
  protected void setTitleBar()
  {
    ...
    this.tvTitle.setText(2131428385);
 ...
 * Qualified Name:     com.kaixin001.activity.GetPwdByPhoneActivity
