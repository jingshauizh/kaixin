  ...
  implements GestureDetector.OnGestureListener
{
  ...
  private void addUpdateBar()
  {
    ...
    this.mPullHeader = LayoutInflater.from(getContext()).inflate(2130903303, null);
    addView(this.mPullHeader);
    this.mTitle = ((TextView)findViewById(2131363482));
    this.mTvTime = ((TextView)findViewById(2131363483));
    ...
    implements Runnable
  {
    ...
    protected Scroller mScroller = new Scroller(PullToRefreshView.this.getContext());
    ...
    public void run()
    {
      ...
      PullToRefreshView.this.move(this.mLastFlingX - i, false);
 ...
 * Qualified Name:     com.kaixin001.view.PullToRefreshView
